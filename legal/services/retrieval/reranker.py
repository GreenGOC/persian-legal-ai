...
class Reranker:
    ...
    def __init__(self, model_name=None, max_length=512, device=None):
        ...
        # self.model_name = os.getenv("COHERE_RERANK_MODEL")
        # self.model = cohere.ClientV2()
        self.model = CrossEncoder(model_name, device=device, max_length=max_length, local_files_only=True)
    ...
    def _build_provision_text(self, provision):
        provision_type = {
            ...
            "item": "جزء",
            "other": "مقرره",
        }.get(provision.provision_type, "مقرره")
    ...
    def rerank(self, query, results, top_k=100):
        ...
        pairs = [(query, self._get_text(result)) for result in results]
        ...
        # try:
        #     write_last_query_log("reranker", query, final)
        # except Exception:
        #     pass
